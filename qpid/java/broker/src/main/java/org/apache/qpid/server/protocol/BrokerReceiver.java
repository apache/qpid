...
public class BrokerReceiver implements Receiver<java.nio.ByteBuffer>, LogSubject
{
    ...
    private DelegateCreator creator_0_8 = new DelegateCreator()
    {
        ...
        {
            return new AMQProtocolEngine(_appRegistry.getVirtualHostRegistry(), _transport, _network, _sender, _connectionId);
        }
    };
    ...
    private DelegateCreator creator_0_10 = new DelegateCreator()
    {
        ...
        public Receiver<java.nio.ByteBuffer> getProtocolEngine()
        {
            ...
            ServerConnection conn = new ServerConnection(_connectionId);
