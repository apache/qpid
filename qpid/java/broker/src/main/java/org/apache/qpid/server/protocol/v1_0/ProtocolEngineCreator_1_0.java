...
public class ProtocolEngineCreator_1_0 implements ProtocolEngineCreator
{
    ...
    public ProtocolEngineCreator_1_0()
    {
    }
    ...
    public ServerProtocolEngine newProtocolEngine(Broker broker,
                                                  ...
                                                  long id)
    {
        return new ProtocolEngine_1_0_0(network, broker, id);
    }

    private static ProtocolEngineCreator INSTANCE = new ProtocolEngineCreator_1_0();
