...
public class ProtocolEngineCreator_1_0_SASL implements ProtocolEngineCreator
{
    ...
    public ProtocolEngineCreator_1_0_SASL()
    {
    }
    ...
    public ServerProtocolEngine newProtocolEngine(Broker broker,
                                                  ...
                                                  long id)
    {
        return new ProtocolEngine_1_0_0_SASL(network, broker, id);
    }

    private static ProtocolEngineCreator INSTANCE = new ProtocolEngineCreator_1_0_SASL();
