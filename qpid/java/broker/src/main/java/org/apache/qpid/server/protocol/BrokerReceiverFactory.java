...
/**
 * The {@link ReceiverFactory} for the broker.
 * 
 * This is used by broker's {@link IncomingNetworkTransport} to negotiates the correct
 * version of AMQP and create a {@link Receiver} that implements it to process incoming
...
public class BrokerReceiverFactory implements ReceiverFactory
{
    ...
    public static final Set<VERSION> ALL_VERSIONS = EnumSet.allOf(VERSION.class);
